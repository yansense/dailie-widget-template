    ...
    rollupOptions: {
      ...
      external:
        process.env.BUNDLE_SDK === "true"
          ? ["react", "react-dom", "react/jsx-runtime", "framer-motion", "zod"] // SDK NOT in external = bundled
          : ["react", "react-dom", "react/jsx-runtime", "dailie-widget-sdk", "framer-motion", "zod"], // SDK in external = not bundled
      output: {
